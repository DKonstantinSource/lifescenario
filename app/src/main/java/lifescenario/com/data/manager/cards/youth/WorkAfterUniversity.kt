...
object WorkAfterUniversity {
    val cards = listOf(
        CardEntity(
            ...
            salary = 2000,
            tax = 1100,
            backgroundImage = "image_manager_logistic.jpg"
        ),
        CardEntity(
            cardPersonalId = 152,
            ...
            salary = 1400,
            tax = 450,
            backgroundImage = "image_laboratory.jpg"
        ),
        CardEntity(
            cardPersonalId = 153,
            title = "IT-специалист",
            ...
            salary = 2500,
            tax = 2900,
            backgroundImage = "image_it_work.jpg"
        ),
        CardEntity(
            cardPersonalId = 154,
            title = "Судья",
            ...
            salary = 2200,
            tax = 1700,
            backgroundImage = "image_judge.jpg"
        ),
        CardEntity(
            cardPersonalId = 155,
            ...
            salary = 1900,
            tax = 200,
            backgroundImage = "image_freelance.jpg"
        ),
        CardEntity(
            cardPersonalId = 156,
            title = "Пилот",
            ...
            salary = 2700,
            tax = 2000,
            backgroundImage = "image_pilot.jpg"
        )
    )
}